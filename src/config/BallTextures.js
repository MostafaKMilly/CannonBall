export const loadBallTextures = (textureLoader) => {
    ...
    const stealAmbientOcclusionTexture = textureLoader.load('textures\\ball\\steal\\ambientOcclusion.jpg')
    const stealRoughnessTexture = textureLoader.load('textures\\ball\\steal\\roughness.jpg')
    const stealMetalnessTexture = textureLoader.load('textures\\ball\\steal\\metalness.jpg')

    const woodColor = textureLoader.load('textures\\ball\\wood\\color.jpg')
    const woodNormal = textureLoader.load('textures\\ball\\wood\\normal.jpg')
    const woodAmbientOcclusionTexture = textureLoader.load('textures\\ball\\wood\\ambientOcclusion.jpg')
    const woodRoughnessTexture = textureLoader.load('textures\\ball\\wood\\roughness.jpg')
    ...
    const rubberAmbientOcclusionTexture = textureLoader.load('textures\\ball\\rubber\\ambientOcclusion.jpg')
    const rubberRoughnessTexture = textureLoader.load('textures\\ball\\rubber\\roughness.jpg')
